...
Если вы используете Linux, также попробуйте [всплывающее окно](https://devamitta.github.io/setup_scan_popup_ru.html) сканирования — оно позволяет открыть слово в словаре одним щелчком мыши.

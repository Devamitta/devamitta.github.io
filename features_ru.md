...
Когда вы используете большое колличество словрей в GoldenDict, бывает полезно сузить поиск только в одном или нескольких словарях. Для этого существует функция групп. В главном меню перейдите в «Правка» > «Словари» (F3) и перейдите во вкладку «Группы». Нажмите на клавишу **Добавить**, напишите название группы, выберете нужные словари для группы и перенесите их используя клавишу **>**. Когда вы закончите нажмите **ОК**
...
Например, если вам нужно найти слово на Пали зная русский перевод. Здесь возможны настройки точного поиска, так и поиска по частям слова. Важно помнить что поиск проводится в выбранной группе словарей. Поэтому чтобы сузить поиск внутри определенного словаря, используйте группы.
